...
// React.lazyを使用して動的インポート
const HomePage = reactLazy(() => import('@wsh-2025/client/src/pages/home/components/HomePage'));
const EpisodePage = reactLazy(() => import('@wsh-2025/client/src/pages/episode/components/EpisodePage'));
const ProgramPage = reactLazy(() => import('@wsh-2025/client/src/pages/program/components/ProgramPage'));
const SeriesPage = reactLazy(() => import('@wsh-2025/client/src/pages/series/components/SeriesPage'));
const TimetablePage = reactLazy(() => import('@wsh-2025/client/src/pages/timetable/components/TimetablePage'));
const NotFoundPage = reactLazy(() => import('@wsh-2025/client/src/pages/not_found/components/NotFoundPage'));
