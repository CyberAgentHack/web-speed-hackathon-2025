          ...
          return (
            <>
              <div className="grow-1 shrink-1 p-[24px]">
                <div className="text-ellipsis-2 mb-[16px] w-full text-center text-[22px] font-bold text-[#ffffff]">
                  {episode.title}
                </div>
                <div className="text-ellipsis-3 w-full text-center text-[14px] font-bold text-[#ffffff]">
                  {episode.description}
                </div>
              </div>
