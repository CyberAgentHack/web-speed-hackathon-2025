...
import { LinkOrA } from '@wsh-2025/client/src/features/layout/components/LinkOrA';
...
export const PureLayout: FC<Props> = ({
  children,
  isLoading = false,
  isSignedIn = false,
  ...
  return (
    <>
      ...
      >
        ...
        >
          <LinkOrA className="pointer-events-auto block flex w-[188px] items-center justify-center px-[8px]" to="/">
