...
import { JpegToWebp } from '@wsh-2025/client/src/util-tmp/jpegToWebp';
          ...
          <div className="m-auto mb-[16px] h-auto w-full max-w-[1280px] outline outline-[1px] outline-[#212121]">
            {isSignInRequired ? (
              <div className="relative size-full">
                <img alt="" className="h-auto w-full" loading="lazy" src={JpegToWebp(episode.thumbnailUrl)} />
                  ...
                  <AspectRatio ratioHeight={9} ratioWidth={16}>
                    <div className="grid size-full">
                      <img
                        ...
                        loading="lazy"
                        src={JpegToWebp(episode.thumbnailUrl)}
                      />
