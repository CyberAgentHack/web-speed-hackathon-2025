...
// React.lazy を使って遅延読み込み
const Player = lazy(() => import('@wsh-2025/client/src/features/player/components/Player').then(module => ({ default: module.Player })));
const PlayerController = lazy(() => import('@wsh-2025/client/src/pages/episode/components/PlayerController').then(module => ({ default: module.PlayerController })));
        ...
        <Flipped stagger flipId={`episode-${episode.id}`}>
          <div className="m-auto mb-[16px] h-auto w-full max-w-[1280px] outline outline-[1px] outline-[#212121]">
            {isSignInRequired ? (
              ...
              <Suspense fallback={<AspectRatio ratioHeight={9} ratioWidth={16}><div className="loading-spinner" /></AspectRatio>}>
                <div className="relative size-full">
                  <Player
                    className="size-full"
                    playerRef={playerRef}
