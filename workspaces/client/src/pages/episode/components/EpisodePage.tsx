...
export async function prefetch(store: ReturnType<typeof createStore>, { episodeId }: Params) {
    invariant(episodeId);
                ...
                <Flipped stagger flipId={`episode-${episode.id}`}>
                    <div className="m-auto mb-[16px] h-auto w-full max-w-[1280px] outline outline-[1px] outline-[#212121]">
                        {isSignInRequired ? (
                            <div className="relative size-full">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#00000077] p-[24px]">
                                    ...
                                    <button
                                        ...
                                        type="button"
                                        onClick={(useAuthActions()).openSignInDialog}
                                    >
                                        ログイン
                                    </button>
                                </div>
                            ...
                            <Suspense
                                fallback={<AspectRatio ratioHeight={9} ratioWidth={16}>
