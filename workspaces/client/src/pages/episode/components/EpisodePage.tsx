      ...
      <div className="px-[24px] py-[48px]">
                ...
                fallback={
                  ...
                  >
                    <div className="grid size-full">
                      ...
                      <img className="size-[48px] place-self-center text-[#ffffff] [grid-area:1/-1]" loading="lazy" src="/public/svg/loading.svg" />
        ...
        <div className="mb-[24px]">
          <div className="text-[16px] text-[#ffffff]">
            <CustomEllipsis maxLine={1} text={episode.series.title} visibleLine={1} />
          </div>
