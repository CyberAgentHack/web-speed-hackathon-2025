...
import liveFilled from '@iconify/icons-fluent/live-24-filled';
      ...
      <div className="absolute inset-x-0 bottom-0 px-[12px]">
        <div className="flex w-full flex-row items-center justify-between">
          <div className="flex flex-row items-center">
            <Icon icon={liveFilled} width="20px" height="20px" className="m-[14px] text-[#FFFFFF]" />
          ...
          <div className="flex flex-row items-center">
            <Hoverable classNames={{ default: 'bg-transparent', hovered: 'bg-[#FFFFFF1F]' }}>
              ...
              >
                <Icon
                  icon={muted ? volumeOffRounded : volumeUpRounded}
                  width="20px"
                  height="20px"
                  className="m-[14px] text-[#FFFFFF]"
                />
              </button>
            </Hoverable>
          </div>
