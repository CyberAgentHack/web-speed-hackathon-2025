    ...
    <Dialog isOpen={isOpen} onClose={onClose}>
      <div className="size-full">
        <div className="mb-[16px] flex w-full flex-row justify-center">
          <img loading="lazy" decoding="async" fetchPriority="low"  className="object-contain" height={36} src="/public/arema.svg" width={98} />
        </div>
        ...
        <img loading="lazy" decoding="async" fetchPriority="low"  alt="" className="mb-[24px] w-full" src={FeatureExplainImageUrl} />
